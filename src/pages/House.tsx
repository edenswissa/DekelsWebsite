            ...
            <div className="container mx-auto px-4 py-2 md:py-4 pt-2 md:pt-4">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-6">
                        {/* Logo */}
                        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.1 }} className="mb-2">
                            <img src="./images/house/logo2.png" alt="לוגו בית דקל" className="h-40 md:h-40 mx-auto object-contain" />
                        </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            {/* Main Story */}
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="bg-primary-fifth/5 rounded-2xl p-8">
                                <div className="space-y-6">
                                    <p className="text-lg text-primary-fourth leading-relaxed">
                                        בית דקל הוקם לזכרו של סרן דקל סויסה, שראה באירוח ובנתינה דרך חיים. מהפנימייה הצבאית, השנת שירות, המכינה בעלי והשירות הקרבי במגלן וגולני ועד הבית במושב – דקל
                                        תמיד דאג לפתוח את הדלת ואת הלב לחבריו ולחייליו.
                                    </p>

                                    <p className="text-lg text-primary-fourth leading-relaxed">בהובלת משפחתו ובעזרת עמותת נחמה והצלה לישראל, הבית ממשיך את דרכו.</p>

                                    <p className="text-lg text-primary-fourth leading-relaxed">בית דקל הוא מקום מפגש ומנוחה לחיילים – לכמה שעות או כמה ימים – מקום לעצור בו רגע, לנשום, להתחזק.</p>
                                </div>
                            </motion.div>
                            ...
                            >
                                <blockquote className="text-xl md:text-2xl font-bold text-primary-fifth mb-4 text-center">
                                    "לאדם יש שתי אפשרויות – או להתעסק בעצמך,
                                    <br /> או לעשות דברים טובים."
                                </blockquote>
                            </motion.div>

                            {/* Bottom Text */}
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="text-center">
                                <p className="text-lg font-bold text-primary-fourth">אנחנו כאן כדי להמשיך ולעשות את הדברים הטובים. באורו של דקל.</p>
                            </motion.div>
                            ...
                            >
                                <h2 className="text-2xl font-bold text-primary-fifth mb-6">כאן אפשר</h2>
                            ...
                            >
                                <h3 className="text-lg font-bold text-primary-fifth mb-4">כתבה על הבית</h3>
                                <div className="bg-gray-100 rounded-xl aspect-video overflow-hidden">
                                    <video controls className="w-full h-full object-contain" poster="./images/house/logo2.png">
                            ...
                            <motion.div
                                ...
                                className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm"
                            >
                                <h3 className="text-lg font-bold text-primary-fifth mb-4">תמונות מהבית</h3>
                                <div className="relative bg-gray-100 rounded-xl aspect-video overflow-hidden">
                                    <img src={houseImages[currentImageIndex]} alt={`תמונה ${currentImageIndex + 1} מהבית`} className="w-full h-full object-contain" />
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.7 }} className="space-y-6">
                            ...
                            >
                                <h3 className="text-lg font-bold text-primary-fifth mb-4">בחסות ובתמיכה</h3>
                                <div className="flex items-center justify-center">
                                    <img src="./images/house/logo1.jpg" alt="לוגו העמותה" className="h-40 w-40 object-contain" />
                                </div>
                                <p className="text-sm text-primary-fourth mt-3">עמותת נחמה והצלה לישראל</p>
                            </motion.div>

                            {/* Map */}
                            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                                <h3 className="text-lg font-bold text-primary-fifth mb-4">מיקום הבית</h3>
                            ...
                            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                                <div className="flex items-center justify-center gap-4">
                                    <h3 className="text-lg font-bold text-primary-fifth">עקבו אחרינו</h3>
                                    <a
                            ...
                            >
                                <h3 className="text-sm font-bold text-primary-fifth mb-3">House of Deke - ILTV</h3>
                                <div className="bg-gray-100 rounded-lg aspect-video overflow-hidden">
                                    <video controls className="w-full h-full object-contain" poster="./images/house/PHOTO-2025-05-22-06-19-19.jpg">
